        ...
        <div v-else class="conversation-container">
            <header>
                <div class="title-container">
                    <div>
                        <h1 class="single-line" @click.stop="toggleConversationInfo2">{{ conversationTitle }}</h1>
            ...
            >
				...
				<Baoxiunew
				    v-if="showConversationInfo2"
					:conversation-info="sharedConversationState.currentConversationInfo"
				    v-bind:class="{ active: showConversationInfo2 }"
				    class="conversation-info-container2"
				/>
...
import Baoxiunew from "../../main/setting/Baoxiunew.vue";
...
export default {
    ...
    methods: {
		...
		toggleConversationInfo2() {
			this.showConversationInfo2=false;
			this.toggleConversationInfo()
		},
		laqibaoxiu(){
			if(this.showConversationInfo2){
				this.showConversationInfo2=false;
			}else{
				this.showConversationInfo2=true;
			}
		},
        setWindowAlwaysTop() {
...
.conversation-info-container2.active {
    display: flex;
}
i:hover {
    color: #1f64e4;
